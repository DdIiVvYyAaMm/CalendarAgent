...
class MeetingScheduler:
    ...
    def __init__(self, config, gmail_agent: GmailAgent, calendar_agent: CalendarAgent):
        self.config = config
                ...
                if event:
                    ...
                    self.gmail_agent.send_email(
                        ...
                        body=(
                            ...
                            "works! I've scheduled it on my calendar. See you then!\n\nThanks."
                        )
                    )
                    return
                else:
    ...
    def run_scheduler_loop(self):
        ...
        while True:
            messages = self.gmail_agent.check_new_messages()
            for msg in messages:
                msg_id = msg['id']
